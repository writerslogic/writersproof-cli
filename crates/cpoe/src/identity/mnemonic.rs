...
impl MnemonicHandler {
    ...
    pub fn derive_silicon_seed(phrase: &str) -> Result<SensitiveSeed> {
        log::debug!(
            "MnemonicHandler::derive_silicon_seed: phrase_len={}",
            phrase.len()
        );
    ...
    pub fn get_machine_fingerprint(phrase: &str) -> Result<String> {
        log::debug!(
            "MnemonicHandler::get_machine_fingerprint: phrase_len={}",
            phrase.len()
        );
    ...
    pub fn phrase_to_entropy(phrase: &str) -> Result<Zeroizing<Vec<u8>>> {
        log::debug!(
            "MnemonicHandler::phrase_to_entropy: phrase_len={}",
            phrase.len()
        );
    ...
    pub fn entropy_to_phrase(entropy: &[u8]) -> Result<Zeroizing<String>> {
        log::debug!(
            "MnemonicHandler::entropy_to_phrase: entropy_len={}",
            entropy.len()
        );
