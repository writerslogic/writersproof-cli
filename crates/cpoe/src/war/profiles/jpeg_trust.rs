...
pub struct JpegTrustProfile {
    /// Profile identifier (e.g., "cpoe-attestation-v1").
...
pub struct TrustIndicator {
    ...
    /// Source system: "cpoe_attestation", "c2pa_manifest", "rfc3161_timestamp".
    pub source: String,
...
mod tests {
    ...
    #[test]
    fn test_cpoe_trust_profile_has_three_indicators() {
        let profile = cpoe_trust_profile();
        assert_eq!(profile.trust_indicators.len(), 3);
        assert_eq!(profile.profile_id, "cpoe-attestation-v1");
    }
    ...
    fn test_jpeg_trust_profile_indicators_present() {
        ...
        for indicator in &profile.trust_indicators {
            ...
            assert_eq!(indicator.source, "cpoe_attestation");
        }
    }
