...
Vendors are encouraged to link to the **[Privacy & External Interactions](https://github.com/writerslogic/writersproof-cli/wiki/Privacy-&-External-Interactions)** page in their own documentation to provide transparency to users.
